...
plugins=(git git-flow osx rails zsh-syntax-highlighting heroku history-substring-search brew tmux docker docker-compose)
...
export PATH=/usr/local/bin:/usr/local/sbin:/Users/tsaiid/.local/bin:$PATH
